...
knight_health_bar = HealthBar(100, screen_height - bottom_panel + 40, knight.max_hp, knight.hp)
bandit1_health_bar = HealthBar(550, screen_height - bottom_panel + 40, bandit1.max_hp, bandit1.hp)
bandit2_health_bar = HealthBar(550, screen_height - bottom_panel + 100, bandit1.max_hp, bandit1.hp)
